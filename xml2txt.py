...
# xmlfiles = os.listdir('/home/gttintern/cpp_learn/maskDetection/labelme2VOC2007mat/source/xmlfiles')
numofxml = xmlfiles.__len__()
for xmlfile in xmlfiles:
    #索引目录下的xml文件
    xmlfilepath = './source/xmlfiles/' + xmlfile
    # xmlfilepath = '/home/gttintern/cpp_learn/maskDetection/labelme2VOC2007mat/source/xmlfiles/' + xmlfile
    ...
    # node_imagesize = dom.getElementsByTagName('size')
    nrows = node_imagesize[0].getElementsByTagName('nrows')[0].firstChild.data
    # nrows = node_imagesize[0].getElementsByTagName('height')[0].firstChild.data
    ncols = node_imagesize[0].getElementsByTagName('ncols')[0].firstChild.data
    # ncols = node_imagesize[0].getElementsByTagName('width')[0].firstChild.data
